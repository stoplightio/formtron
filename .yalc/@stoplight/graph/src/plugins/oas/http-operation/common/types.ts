...
export type Oas2TranslateOperationOptions = ITranslateOperationOptions<Operation, Path, Spec>;
export type Oas3TranslateOperationOptions = ITranslateOperationOptions<OperationObject, PathObject, OpenAPIObject>;
