export declare enum Oas2RootNodeTypes {
    OAS2 = "oas2",
...
export declare enum Oas2ChildNodeTypes {
    SECURITY_SCHEME = "oas2_security_scheme",
    PATH = "oas2_path",
    TAG = "oas2_tag"
}
declare type OasBaseParamType = 'header' | 'query' | 'path';
export declare type Oas2ParamType = OasBaseParamType | 'body';
export declare type Oas3ParamType = OasBaseParamType | 'cookie';
export declare enum Oas3RootNodeTypes {
    OAS3 = "oas3",
    SHARED = "oas3_shared",
    TAGS = "oas3_tags",
...
export declare enum Oas3ChildNodeTypes {
    SECURITY_SCHEME = "oas3_security_scheme",
    PATH = "oas3_path",
    TAG = "oas3_tag",
    SERVER = "oas3_server"
}
export declare enum OasNodeChildType {
    OBJECT = 1,
    ARRAY = 2
}
export declare enum Oas2SharedNodeTypes {
...
export declare enum Oas3SharedNodeTypes {
